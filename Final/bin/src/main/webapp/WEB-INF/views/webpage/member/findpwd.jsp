	...
	<div id="wrap">
	    ...
	    <div id="content">
	        <div class="label_div">
	            ...
	            <label for="name" class="label">이름/Name</label>
	            <span></span>
	        </div>
	        <div class="label_div">
	        ...
	        <div class="label_div">
	            ...
	            <label for="phone" class="label">핸드폰번호/Phone</label>
	            <span></span>
	        </div>
	        <div class="label_div">
	            <input type="email" id="email" name="email" required>
	            <label for="email" class="label">이메일/E-mail </label>
	            <span></span>
	        </div>
	        <div class="label_div">
	            <input type="number" id="birth" name="birth" required>
	            <label for="birth" class="label">생년월일/Birth</label>
	            <span></span>
	        </div>
