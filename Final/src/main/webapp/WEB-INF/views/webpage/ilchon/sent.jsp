...
<br><br>
    ...
    <div class="tab">
        <ul class="tabnav">
            <li><div id="fromRequest" onclick="location.href='${ path }/webpage/ilchon/inbox'">받은 신청</div></li>
            <li><div id="toRequest" onclick="location.href='${ path }/webpage/ilchon/sent'" button style="border-bottom: 2px solid rgb(243, 156, 18); color: rgb(243, 156, 18); cursor: default;" disabled>보낸 신청</div></li>
        </ul>
					...
					<thead>
						...
						<c:forEach var="request" items="${request}">
							<tr>
								...
								<td>
									<input value="내용" type="button" id="modal-open" class="modal-open" onclick="javascrit:window.open('${ path }/webpage/ilchon/readModal?no=${ request.requestNo }','popup_1','width=400px,height=500px,toolbar=no,location=no,status=no,menubar=no,scrollbars=no,resizable=no,left=300px,top=100px')">
								</td>
							</tr>
						</c:forEach>
						</tbody>
