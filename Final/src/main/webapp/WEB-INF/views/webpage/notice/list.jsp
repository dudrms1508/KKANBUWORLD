    ...
    <div id="wrap">
        ...
        <div id="content">
            ...
            <br><br><br>
                ...
                <input type="text" id="input_select" name="keyword"  value="">
            ...
            <input type="button" class="viewCount" value="<<" onclick="location.href='${ path }/webpage/notice/list?page=1'">
            <input type="button" class="viewCount" value="<" onclick="location.href='${ path }/webpage/notice/list?page=${ pageInfo.prevPage }'">
            ...
            <c:forEach  begin="${ pageInfo.startPage }" end="${ pageInfo.endPage }" varStatus="status">
            	<c:choose>
					...
					<c:otherwise>						
						<input type="button" class="viewCount" onclick="location.href='${ path }/webpage/notice/list?page=${ status.current }'" value="${ status.current }" />
					</c:otherwise>
				</c:choose>
            </c:forEach>
            
             
            <input type="button" class="viewCount" value=">" onclick="location.href='${ path }/webpage/notice/list?page=${ pageInfo.nextPage }'">
            <input type="button" class="viewCount" value=">>" onclick="location.href='${ path }/webpage/notice/list?page=${ pageInfo.maxPage }'">
        </div>
    </div>
