...
<body>
	...
	<div id="content">	
		...
		<form action="${path}/webpage/member/login" method="post" >
			...
			<br> <br>
		    <input type="submit" id="input_login" class="button"  value="로  그  인"><br>
		</form> 
		...
		<div class="a_find">
			...
			<a href="" style =" text-decoration:none;color: blue;">회원가입 </a>
 			...
 			<a href="javascript:kakaoLogin();"><img  src="${path}/resources/image/kakao.png" width="300" height="60"></a><br>
	    
			<img  src="${path}/resources/image/google.png" width="300" height="60" onclick="googleLogin()"><br>
			<img  src="${path}/resources/image/naver.png" width="300" height="60" onclick="naverLogin()"><br>
