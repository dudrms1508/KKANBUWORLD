...
<body>
    <div id="wrapdiv">
        <div id="wrapleftdiv">
            <!-- <div id="selectdiv">
                <div id="selbtn1"><button type="button" class="selectbutton">구매/결제내역</button></div>
                <div id="selbtn2"><button type="button" class="selectbutton">보낸선물</button></div>
                <div id="selbtn3"><button type="button" class="selectbutton">받은선물</button></div>
                <div id="blankdiv"></div>
            </div> -->
            <div id="categorydiv">
                <ul id="categoryul">
                    <li id="paymentHistory"><button style="border-bottom: 2px solid rgb(243, 156, 18); color: rgb(243, 156, 18); cursor: default;">구매/결제내역</button></li>
                    <li id="sendGift"><button onclick="location.href='${ path }/webpage/mypage/sendgifthistory'">보낸선물</button></li>
                    <li id="receiveGift"><button onclick="location.href='${ path }/webpage/mypage/receivegifthistory'">받은선물</button></li>
                </ul>
            </div>
            <div id="perioddiv">
                <div id="periodinner">
            ...
            <div id="periodtextdiv">
                <span id="dateSpan"><b>최근 ${ loginMember.name }님의 구매내역입니다.</b></span>
...
window.onload = function() {
    ...
    chkbtn1.addEventListener('click', () => {
        ...
        // newDate.setDate(newDate.getDate() - 7); // 일주일
        ...
        // newDate.setMonth(newDate.getMonth() - 5) // 5개월 전
        // newDate = dateFormatter(newDate, endDate);
        // console.log(newDate);
...
//             type: 'get',
            type: 'post',
            url: '${path}/webpage/mypage/payhistory/seldate',
            dataType: 'text',
            data: {
//                 list : '${list}',
                date1,
...
function paging(str) {
	...
	if(date1 == '' && date2 == '') {
		...
		$.ajax({
			type: 'post',
			url : '${ path }/webpage/mypage/payhistory/list',
			dataType: 'text',
			data: {
				page,
				date1,
