        ...
        <div id="wrapleftdiv">
            <div id="categorydiv">
                <ul id="categoryul">
                    ...
                    <li id="deleteAccount"><button style="border-bottom: 2px solid rgb(243, 156, 18); color: rgb(243, 156, 18); cursor: default;">회원탈퇴</button></li>
                </ul>
            </div>
            <div id="privatetextdiv">
                <span><b>탈퇴하시려면 회원님의 비밀번호를 입력해주세요.</b></span>
                <span style="color: rgb(243, 156, 18);"></span>
            </div>
            <form action="${ path }/webpage/mypage/accountdel" method="post" id="tableformdiv">
                <div id="rectanglediv">
                    <div id="tablediv">
                        <table>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td><input type="password" name="checkPwd" id="checkPwd" class="inputchg" placeholder="변경할 비밀번호를 입력하세요." required></td>
                            </tr>
                        </table>
                    </div>
                </div>
                ...
                <div id="btmbtndiv">
                    ...
                    <input type="submit" id="delbtn" value="탈퇴하기"></input>
                </div>
            </form>
        </div>
