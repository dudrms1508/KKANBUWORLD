        ...
        <div id="wrapleftdiv">
            <div id="categorydiv">
                <ul id="categoryul">
                    ...
                    <li id="sendGift"><button style="border-bottom: 2px solid rgb(243, 156, 18); color: rgb(243, 156, 18); cursor: default;">보낸선물</button></li>
            ...
            <div id="periodtextdiv">
                <span id="dateSpan"><b>최근 ${ loginMember.name }님의 보낸 선물내역입니다.</b></span>
            ...
            <div id="pagingdiv">
				...
				<c:forEach begin="${ pageInfo.startPage }" end="${ pageInfo.endPage }" varStatus="status" >
					<c:choose>
						...
						<c:otherwise>
<%-- 			            	<button onclick="location.href='${ path }/webpage/mypage/sendgifthistory/list?page=${ status.current }'" >${ status.current }</button> --%>
...
window.onload = function() {
    ...
    viewbtn.addEventListener('click', (event) => {
        ...
        if(date1 == '' || date2 == '') {
	        ...
	        $.ajax({
	            type: 'post',
	            url: '${ path }/webpage/mypage/sendgifthistory/seldate',
	            dataType: 'text',
	            data: {
	                date1,
	                date2
...
// window.onload 끝
    ...
    function paging(str) {
    	...
    	if(date1 == '' && date2 == '') {
    		...
    		$.ajax({
    			type: 'post',
    			url : '${ path }/webpage/mypage/sendgifthistory/list',
    			dataType: 'text',
    			data: {
    				page,
    				date1,
