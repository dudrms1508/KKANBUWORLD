...
<body>
    <div id="wrapdiv">
        <div id="wrapleftdiv">
            <div id="categorydiv">
                <ul id="categoryul">
                    <li id="qnacategory"><button style="border-bottom: 2px solid rgb(243, 156, 18); color: rgb(243, 156, 18); cursor: default;">문의내역</button></li>
                    <li id="reportcategory"><button onclick="location.href='${ path }/webpage/mypage/report'">신고내역</button></li>
                </ul>
            </div>
            <div id="periodtextdiv">
                <span><b>${ loginMember.name }님의 문의내역입니다.</b></span>
                    ...
                    <c:if test="${ not empty list }">
	                    <c:forEach var="list" items="${ list }">
		                    <tr>    
		                        ...
		                        <td><a href="${ path }/webpage/mypage/qnadetail?qnaNo=${ list.no }" 
		                        onclick="window.open(this.href, '신고하기', 'width=380, height=350, top=200, left=500'); return false;"
		                        id="aTag" >${ list.content }</a></td>
            ...
            <div id="pagingdiv">
            	<button onclick="location.href='${ path }/webpage/mypage/qnahistory?page=${ pageInfo.prevPage }'"><</button>
					<c:forEach begin="${ pageInfo.startPage }" end="${ pageInfo.endPage }" varStatus="status" >
						<c:choose>
							...
							<c:otherwise>
				            	<button type="button" onclick="location.href='${ path }/webpage/mypage/qnahistory?page=${ status.current }'">${ status.current }</button>
							</c:otherwise>
						</c:choose>
					</c:forEach>            
           		<button onclick="location.href='${ path }/webpage/mypage/qnahistory?page=${ pageInfo.nextPage }'">></button>
            </div>
