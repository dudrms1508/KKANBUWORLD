...
<br><br>
    ...
    <div class="tab">
        <ul class="tabnav">
            <li><div id="fromRequest" onclick="location.href='${ path }/webpage/message/inbox'" button style="border-bottom: 2px solid rgb(243, 156, 18); color: rgb(243, 156, 18); cursor: default;" disabled>받은 쪽지</div></li>
            <li><div id="toRequest" onclick="location.href='${ path }/webpage/message/sent'">보낸 쪽지</div></li>
        </ul>

		<div class="tabcontent">
			<div id="toRequest">
				<div class="ilchons">
					<form action="${ path }/webpage/message/inbox" method="POST">
					<%-- <input type="hidden" name="mNo" value="${message}"> --%>
					<table class="tabletype" border="0.5" width="1050px">
					<thead>
						<tr>
							<th>보낸이</th>
							<th>받는이</th>
						...
						<c:forEach var="message" items="${message}">
							<tr>
								...
								<td>${message.messageContnet}</td>
								<td> <fmt:formatDate value="${message.sendDate}" pattern="yyyy-MM-dd hh:mm"/> </td>
								<td>
									<input value="내용" type="button" id="modal-open" class="modal-open" onclick="javascrit:window.open('${ path }/webpage/message/answerMessage?no=${ message.messageNo }','popup_1','width=400px,height=600px,toolbar=no,location=no,status=no,menubar=no,scrollbars=no,resizable=no,left=300px,top=100px')">
								</td>
							</tr>
						</c:forEach>
						</tbody>
