...
<body>
	<div id = "left_side">
		<div id = "left_side_upper">
			<div id = "visitWrapper">
                <label class = "lblVisitCnt">TODAY </label><a id = "todayCnt">&nbsp;투데이나오기&nbsp;</a> 
                <label class = "lblVisitCnt">|&nbsp;&nbsp;TOTAL </label><a>&nbsp;토탈나오기</a>
			</div>
		</div>
		<!-- 홈 & 방명록 기본틀 -->
	...
	<div id = "right_side"> 
        ...
        <div id = "right_side_down">
            <iframe id = "minihome_content" src = "${path}/webpage/notice/list">
            </iframe>
        </div>	
		<div id = "btnWrapper">
            ...
            <button class = "tap_button" id = "gb" onclick="location.href='${ path }/minihome/visitor/${ minihomeNo }'">방명록</button>
